...
public abstract class AbstractGenericTypeSerializerTest {
    ...
    protected abstract <T> TypeSerializer<T> createSerializer(Class<T> type);
    ...
    public static class ComplexNestedObject2 {
        ...
        private final Map<String, ComplexNestedObject1> theMap = new HashMap<>();
        ...
        public ComplexNestedObject2(Random rnd) {
            ...
            this.theMap.put(
                    String.valueOf(rnd.nextLong()), new ComplexNestedObject1(rnd.nextInt()));
            this.theMap.put(
                    String.valueOf(rnd.nextLong()), new ComplexNestedObject1(rnd.nextInt()));
            this.theMap.put(
                    String.valueOf(rnd.nextLong()), new ComplexNestedObject1(rnd.nextInt()));
