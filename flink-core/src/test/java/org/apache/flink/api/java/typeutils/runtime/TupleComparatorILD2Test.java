...
class TupleComparatorILD2Test extends TupleComparatorTestBase<Tuple3<Integer, Long, Double>> {
    ...
    Tuple3<Integer, Long, Double>[] dataISD =
            new Tuple3[] {
                new Tuple3<>(4, 14L, 20.0),
                new Tuple3<>(4, 15L, 23.2),
                new Tuple3<>(5, 15L, 20.0),
                new Tuple3<>(5, 20L, 20.0),
                new Tuple3<>(6, 20L, 23.2),
                new Tuple3<>(6, 29L, 20.0),
                new Tuple3<>(7, 29L, 20.0),
                new Tuple3<>(7, 34L, 23.2)
            };
    ...
    protected TupleComparator<Tuple3<Integer, Long, Double>> createComparator(boolean ascending) {
        return new TupleComparator<>(
                new int[] {0, 1},
                new TypeComparator[] {new IntComparator(ascending), new LongComparator(ascending)},
