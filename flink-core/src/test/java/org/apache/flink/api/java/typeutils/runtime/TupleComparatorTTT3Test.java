...
class TupleComparatorTTT3Test
        ...
        return new TupleComparator<>(
                ...
                new TypeComparator[] {
                    new TupleComparator<Tuple2<String, Double>>(
                            new int[] {0, 1},
                            new TypeComparator[] {
                                new StringComparator(ascending), new DoubleComparator(ascending)
                            },
                            new TypeSerializer[] {
                    ...
                    new TupleComparator<Tuple2<Long, Long>>(
                            new int[] {0, 1},
                            new TypeComparator[] {
                                new LongComparator(ascending), new LongComparator(ascending)
                            },
                            new TypeSerializer[] {
                    ...
                    new TupleComparator<Tuple2<Integer, Long>>(
                            new int[] {0, 1},
                            new TypeComparator[] {
                                new IntComparator(ascending), new LongComparator(ascending)
                            },
    ...
    @Override
    protected Tuple3<Tuple2<String, Double>, Tuple2<Long, Long>, Tuple2<Integer, Long>>[]
            getSortedTestData() {
        return this.dataISD;
    }
