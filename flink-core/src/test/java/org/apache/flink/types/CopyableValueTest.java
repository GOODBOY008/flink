...
public class CopyableValueTest {
    ...
    void testCopy() {
        ...
        for (CopyableValue<?> type : value_types) {
            Assertions.assertEquals(type, type.copy());
        }
    }
    ...
    void testCopyTo() {
        ...
        Assertions.assertEquals(double_from, double_to);
        ...
        Assertions.assertEquals(string_from, string_to);
    }
}
