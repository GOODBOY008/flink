...
public class PrimitiveDataTypeTest {
   ...
   assertThat(pn2).isCloseTo(pn1, within("PactNull not equal to other PactNulls."));
   assertThat(pn1).isCloseTo(pn2, within("PactNull not equal to other PactNulls."));

   assertNotEquals(null, pn1, "PactNull equal to other null.");
